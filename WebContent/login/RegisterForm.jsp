...
<style>
	...
	#u2234-4 {
		z-index: 48;
		display: block;
		font-size: 33px; font-family:'a타이틀고딕2';
		position: relative;
		margin-right: -10000px;
		margin-top: 148px;
		left: 264px;
...
<div class="clearfix" id="page">
		...
		<!-- 여기까지가 Header -->
			...
			<div class="clearfix colelem" id="u2954">
                ...
                <img class="grpelem" id="u2061" alt="나의정보" src="../images/blank.gif?crc=4208392903"/></a>
				
				<!-- 유기동물조회버튼 -->
				<a class="nonblock nontext Button rounded-corners transition clearfix grpelem" id="buttonu2062" href="../animal/animalsList">
				<img class="grpelem" id="u2063" alt="유기동물조회" src="../images/blank.gif?crc=4208392903"/></a>
				 <!-- 멍냥멍냥로고 -->
				<a class="nonblock nontext grpelem" id="u2059-4" href="../index.jsp">
				<img id="u2059-4_img" alt="멍냥멍냥" width="212" height="60" src="../images/u2059-4.png?crc=347814851"/></a>
				
				<!-- 공지사항버튼 -->
				<a class="nonblock nontext Button rounded-corners transition clearfix grpelem" id="buttonu2064" href="../board/boardlist">
                <img class="grpelem" id="u2065" alt="커뮤니티" src="../images/blank.gif?crc=4208392903"/></a>
          ...
          <div class="TabbedPanelsContentGroup clearfix colelem" id="u2861"><!-- stack box -->
           <div class="TabbedPanelsContent grpelem" id="u2866">
			...
			<form method="post" action="../RegisterCheckServlet" id="regfrm" name="userInfo" onsubmit="return checkValue()">
				...
				<input id="userid" type="text" name="userID" maxlength="50"> <div id="btn1BUTTON"><input id="btn1" type="button" value="중복확인" onclick="dCheck();"></div><br><br>
		        <label id="reginfo">비밀번호 : </label>
		        <input type="password" name="userPW" maxlength="50"><br><br>
		        <label id="reginfo">비밀번호 확인 : </label>
		        <input type="password" name="passwordcheck" maxlength="50"><br><br>
		        <label id="reginfo">이름 : </label>
		        <input type="text" name="userName" maxlength="50">
		        <br><br><br><br>
		        <input type="submit" value="가입"/>
		        <input id="btn2" type="button" value="취소" onclick="goLoginForm()">
		        </div>
			</form>
