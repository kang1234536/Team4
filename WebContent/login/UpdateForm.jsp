...
<div class="clearfix" id="page">
		...
		<!-- 여기까지가 Header -->
			...
			<div class="clearfix colelem" id="u2954">
				<!-- 나의정보버튼 -->
				<a class="nonblock nontext Button rounded-corners transition clearfix grpelem" id="buttonu2060" href="../MyInformServlet">
        ...
        <!-- 유형선택 개인or보호소 -->
         ...
         <div class="TabbedPanelsContentGroup clearfix colelem" id="u2861">
           <div class="TabbedPanelsContent grpelem" id="u2866">
			...
			<form id="loginfrm" action="../UpdateServlet" method="post" onsubmit="return checkValue()">
